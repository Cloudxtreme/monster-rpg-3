...
void Pick_Pocketable_Brain::pick_pocket(Map_Entity *pocket_picker, Map_Entity *pocket_pickee)
{
	...
	float picker_agility = (float)picker_stats->characteristics.get_modified_agility(picker_stats);
	float pickee_agility = (float)pickee_stats->characteristics.get_modified_agility(pickee_stats);
